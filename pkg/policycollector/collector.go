...
func (c *PolicyCollector) RegisterPolicyMetricsCollector(pc *PolicyCollector) error {
	collector = pc
	return metrics.RegisterCollector("policyMetrics", newPolicyCollector)
}

func newPolicyCollector() (prometheus.Collector, error) {
